...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
    	...
    	Node graph = generator.analyzeMethod(args[0], args[1]);
    ...
    public static void generate(String className, String methodName) throws IOException {

       
    	GraphGenerator generator = new GraphGenerator();
    	Node graph = generator.analyzeMethod(className, methodName);
